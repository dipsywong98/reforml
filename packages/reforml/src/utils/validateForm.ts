    ...
    if (fieldName in formValue && isDefined(formValue[fieldName])) {
      ...
      if ('fields' in field) {
        if (isFormValue(value)) {
          const subErr = validateForm(value, field.fields as Fields, validatorDictionary)
          if (subErr !== undefined) {
      ...
      if (Array.isArray(value) && isListField(field)) {
        if (field.of !== undefined && typeof field.of !== 'string' && field.of.validate !== undefined) {
          ...
          const subErr = value.map(subValue => validateField(subValue, y, validatorDictionary))
      ...
      if (field.validate !== undefined) {
        const generalErr = validateField(value, field.validate, validatorDictionary)
